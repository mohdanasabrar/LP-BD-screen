...
interface BasicDetailsV1Props {
    onBack: () => void;
    cohort: CohortType;
}

export const BasicDetailsV1: React.FC<BasicDetailsV1Props> = ({ onBack, cohort }) => {
  ...
  // If not prefilled_all, we are always in "edit mode" (standard view).
  ...
  // Fresh customers usually start with unchecked consent. 
  // Others (Partial/Full) start with checked consent (simulating existing user flow).
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 pb-44">
      ...
      <main className="flex-grow">
        ...
        <div className="px-4 py-5 space-y-4">
            ...
            {/* 
                LOGIC:
                If cohort is 'prefilled_all' AND we are NOT in edit mode, show the summary card.
                Otherwise, show the standard expanded sections.
            */}
